...
class DatosPagina extends StatefulWidget {
  const DatosPagina({super.key});

  @override
  State<DatosPagina> createState() => _DatosPaginaState();
}

class _DatosPaginaState extends State<DatosPagina> {
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            Container(
                margin: EdgeInsets.only(top: 20, right: 100, left: 100),
                child: Row(children: [
                  SizedBox(height: 15),
                  Text(
                    "Datos Personales",
